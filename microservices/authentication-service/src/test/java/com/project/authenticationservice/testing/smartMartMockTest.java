...
import org.springframework.boot.test.autoconfigure.web.servlet.AutoConfigureMockMvc;
 ...
 public class smartMartMockTest {
 	...
 	private Users createUser() {
 		Users user = new Users(2,"admin","admin",21,"Male",735,"admin","$2a$10$IoqonpxYeSWir9ir16Pb6.8sCa444mtsH6R6oH.ioWnHkpODsBsPS","O","11","A","what is your Nick name","aa","what is your favorite food","aa","what is your favorite holiday spot","aa");
 		return user;
 	}
 	...
 	public void newSignUp() throws UserAlreadyExistsException {
 		...
 		Users user = new Users(2, "rohith", "narjala", 21,"Male",0, null,"rohith",
 				"$2a$10$R/lZJuT9skteNmAku9Y7aeutxbOKstD5xE5bHOf74M2PHZipyt3yK",null,"1",null,null,null,null,null,null);
 		service.signup(user);
 		LOGGER.info("End");
